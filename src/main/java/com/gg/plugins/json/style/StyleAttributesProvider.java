...
public class StyleAttributesProvider {
    ...
    private static final SimpleTextAttributes INDEX = new SimpleTextAttributes(SimpleTextAttributes.STYLE_BOLD, JBColor.BLACK);
    private static final SimpleTextAttributes KEY_VALUE = new SimpleTextAttributes(SimpleTextAttributes.STYLE_BOLD, KEY_COLOR);
    private static final SimpleTextAttributes INTEGER_TEXT_ATTRIBUTE = new SimpleTextAttributes(SimpleTextAttributes.STYLE_PLAIN, NUMBER_COLOR);
    private static final SimpleTextAttributes BOOLEAN_TEXT_ATTRIBUTE = INTEGER_TEXT_ATTRIBUTE;
    private static final SimpleTextAttributes STRING_TEXT_ATTRIBUTE = new SimpleTextAttributes(SimpleTextAttributes.STYLE_PLAIN, LIGNT_GREEN);
    private static final SimpleTextAttributes NULL_TEXT_ATTRIBUTE = new SimpleTextAttributes(SimpleTextAttributes.STYLE_ITALIC, LIGHT_GRAY);
    private static final SimpleTextAttributes DOCUMENT_TEXT_ATTRIBUTE = new SimpleTextAttributes(SimpleTextAttributes.STYLE_BOLD, LIGHT_GRAY);
