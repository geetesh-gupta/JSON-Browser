...
class PaginationPopupComponent extends JPanel {
	...
	private static String getText(ResultsPerPage resultsPerPage) {
		return ResultsPerPage.ALL.equals(resultsPerPage) ?
		       String.format("%s docs", ResultsPerPage.ALL.label) :
		       String.format("%s docs / page", resultsPerPage.label);
	}
	...
	private String getCurrentText() {
		ResultsPerPage resultsPerPage = pagination.getResultsPerPage();
	...
	private ActionGroup createActionGroup() {
		...
		for (ResultsPerPage resultsPerPage : ResultsPerPage.values()) {
			actionGroup.add(new ResultsPerPageAction(resultsPerPage));
		}
	...
	private class ResultsPerPageAction extends DumbAwareAction {

		private final ResultsPerPage resultsPerPage;

		ResultsPerPageAction(ResultsPerPage resultsPerPage) {
			super(getText(resultsPerPage));
