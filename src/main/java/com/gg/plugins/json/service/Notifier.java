...
public class Notifier {
	...
	private static final String NOTIFICATION_GROUP = "JSONBrowser";
	...
	private Notifier(Project project) {
		...
		this.notificationGroup = NotificationGroupManager.getInstance().getNotificationGroup(NOTIFICATION_GROUP);
	}
	...
	public void notify(String message, NotificationType notificationType) {
		this.notificationGroup.createNotification("[" + NOTIFICATION_GROUP + "] " + message, notificationType)
		                      .notify(project);
	}
