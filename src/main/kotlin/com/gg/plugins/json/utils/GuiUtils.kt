...
object GuiUtils {
    ...
    fun loadIcon(iconFilename: String): Icon {
        return IconLoader.getIcon(ICON_FOLDER + iconFilename, GuiUtils::class.java)
    }
    ...
    fun loadIcon(iconFilename: String?, darkIconFilename: String?): Icon {
        ...
        return IconLoader.getIcon(iconPath!!, GuiUtils::class.java)
    }
    ...
    fun showNotification(component: JComponent?, info: MessageType, message: String?, position: Balloon.Position?) {
        UIUtil.invokeLaterIfNeeded {
            JBPopupFactory.getInstance().createBalloonBuilder(JLabel(message))
